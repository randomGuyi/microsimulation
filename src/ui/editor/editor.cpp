...
editor::editor(QWidget *parent)
    : QWidget(parent), ui(new Ui::editor), m_editor{new QsciScintilla},
  ...
  m_compile_btn->setMinimumWidth(100);
  m_reset_btn->setMinimumWidth(100);
  ...
  setLayout(layout);
  layout->addWidget(topBar); /* at the bottom */
