...
class components_factory : public QObject{
  Q_OBJECT

public:
  static components_factory & instance(){
    static components_factory * f = new components_factory{};
    return *f;
  }

  std::pair<core::components::msim_component *,
                   gui::components::msim_component_widget *>
  create(const QString &id, const QString &label, shared::svg_loader *loader) {
    ...
    if (id.contains("alu")) {
      ...
      cpu.add_component(
          std::make_unique<msim_alu>(id.toStdString(), label.toStdString()));

      msim_alu *comp_ptr =
          dynamic_cast<msim_alu *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(std::make_unique<msim_register>(id.toStdString(),
                                                        label.toStdString()));

      msim_register *comp_ptr =
          dynamic_cast<msim_register *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(
          std::make_unique<msim_bus>(id.toStdString(), label.toStdString()));

      msim_bus *comp_ptr =
          dynamic_cast<msim_bus *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(
          std::make_unique<msim_ram>(id.toStdString(), label.toStdString()));

      msim_ram *comp_ptr =
          dynamic_cast<msim_ram *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(
          std::make_unique<msim_rom>(id.toStdString(), label.toStdString()));

      msim_rom *comp_ptr =
          dynamic_cast<msim_rom *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(
          std::make_unique<msim_clock>(id.toStdString(), label.toStdString()));

      msim_clock *comp_ptr =
          dynamic_cast<msim_clock *>(cpu.get_component(id.toStdString()));

      /*A QT widget can only have one parent, so 2 Clocks are ought to be created*/

      msim_clock_widget *widget = new msim_clock_widget{comp_ptr, loader, id};
      emit clock_widget_created(widget);
      ...
      cpu.add_component(
          std::make_unique<msim_ar>(id.toStdString(), label.toStdString()));

      msim_ar *comp_ptr =
          dynamic_cast<msim_ar *>(cpu.get_component(id.toStdString()));
      ...
      cpu.add_component(
          std::make_unique<msim_cop>(id.toStdString(), label.toStdString()));

      msim_cop *comp_ptr =
          dynamic_cast<msim_cop *>(cpu.get_component(id.toStdString()));
  ...
  signals:
    void clock_widget_created
          (gui::components::msim_clock_widget * widget);

private:
  components_factory() = default;
