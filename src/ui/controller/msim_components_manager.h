...
public:
  ...
  void place_component(gui::drop_target *target, const QString &id,
                       const QString &label);
...
private:
  ...
  std::pair<core::components::msim_connector *,
            gui::components::msim_connector_widget *>
  get_or_create_connector(QString conn_id);
  std::pair<core::components::msim_decoder *,
            gui::components::msim_decoder_widget *>
  get_or_create_decoder(QString decoder_id);
  std::pair<core::components::msim_component *,
            gui::components::msim_component_widget *>
  get_or_create_component(QString const &comp_id, QString const &label);
  std::pair<core::components::msim_bit *, gui::components::msim_bit_widget *>
  get_or_create_bit(QString bit_id);
  std::pair<core::components::msim_line *, gui::components::msim_line_widget *>
  get_or_create_line(QString const &line_id);
  ...
  QMap<QString, std::pair<core::components::msim_component *,
                          gui::components::msim_component_widget *>>
      m_placed_components;

  QMap<QString, std::pair<core::components::msim_connector *,
                          gui::components::msim_connector_widget *>>
      m_placed_connectors;

  QMap<QString, std::pair<core::components::msim_line *,
                          gui::components::msim_line_widget *>>
      m_placed_lines;
  ...
  QMap<QString, std::pair<core::components::msim_decoder *,
                          gui::components::msim_decoder_widget *>>
      m_placed_decoders;

  QMap<QString, std::pair<core::components::msim_bit *,
                          gui::components::msim_bit_widget *>>
      m_placed_bits;
};
} // namespace fac
