...
namespace  fac {
    ...
    public:
        static std::pair<core::components::msim_connector *, gui::components::msim_connector_widget *>
        ...
        static std::pair<core::components::msim_enable_bit * , gui::components::msim_enable_bit_widget *>
